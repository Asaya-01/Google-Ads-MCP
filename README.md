...
> **This is a vendored copy of [googleads/google-ads-mcp](https://github.com/googleads/google-ads-mcp).**
> For the install and credential steps we use, start with **[SETUP.md](SETUP.md)**.
> Provenance and how to sync with upstream: **[UPSTREAM.md](UPSTREAM.md)**.
